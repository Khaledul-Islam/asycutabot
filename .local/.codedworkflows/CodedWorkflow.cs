...
namespace asycutabot
{
    ...
    {
        private Lazy<global::asycutabot.WorkflowRunnerService> _workflowRunnerServiceLazy;
        private Lazy<ConnectionsManager> _connectionsManagerLazy;
        private Lazy<global::asycutabot.WorkflowRunnerService> __asycutabotLazy;
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::asycutabot.WorkflowRunnerService>(() => new global::asycutabot.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
            __asycutabotLazy = new Lazy<global::asycutabot.WorkflowRunnerService>(() => new global::asycutabot.WorkflowRunnerService(this.services));
        }

        protected global::asycutabot.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
...
#pragma warning restore
        protected global::asycutabot.WorkflowRunnerService _asycutabot => __asycutabotLazy.Value;
    }
}